...
export default function ImportadorSped() {
  ...
  const BotoesAcao = () => (
    <div className="no-print act-btns" style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '20px', marginTop: '30px', padding: '20px', backgroundColor: '#fff', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
      ...
      <div style={{ display: 'flex', height: '100vh', width: '100vw', backgroundColor: '#f0f4f8', alignItems: 'center', justifyContent: 'center', fontFamily: 'system-ui, sans-serif', margin: 0, padding: 0 }}>
        <div style={{ backgroundColor: '#fff', padding: '50px', borderRadius: '20px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)', width: '100%', maxWidth: '400px', textAlign: 'center' }}>
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              <input type="password" placeholder="Insira sua Chave de Acesso" value={senhaInput} onChange={(e) => setSenhaInput(e.target.value)} style={{ width: '100%', boxSizing: 'border-box', padding: '15px', borderRadius: '12px', border: '2px solid #cbd5e1', fontSize: '16px', outline: 'none', textAlign: 'center', transition: 'border 0.3s' }} onFocus={(e) => e.target.style.borderColor = '#004080'} onBlur={(e) => e.target.style.borderColor = '#cbd5e1'} />
              {erroLogin && <span style={{ color: '#ef4444', fontSize: '12px', display: 'block', marginTop: '8px', fontWeight: 'bold' }}>{erroLogin}</span>}
            </div>
            <button type="submit" style={{ padding: '15px', backgroundColor: '#004080', color: '#fff', border: 'none', borderRadius: '12px', fontSize: '16px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', transition: 'background 0.3s' }} onMouseOver={(e) => e.target.style.backgroundColor = '#003366'} onMouseOut={(e) => e.target.style.backgroundColor = '#004080'}><Lock size={18} /> Acessar Sistema</button>
          </form>
        </div>
      </div>
    );
  ...
  return (
    <div className="main-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '100vh', backgroundColor: '#f0f4f8', padding: '30px', boxSizing: 'border-box', fontFamily: 'system-ui, sans-serif', width: '100%' }}>
      
      <style>
        {`
          /* Vacina Anti-Vite para forçar ocupação total na tela e evitar cortes */
          ...
          /* ================================================================================== */
          /* MODO DE IMPRESSÃO PDF: BLINDADO CONTRA CORTES, GRÁFICOS GIGANTES E TEXTOS FORA DO LUGAR */
          /* ================================================================================== */
          @media print {
            ...
            .main-container { padding: 0 !important; background: #fff !important; display: block !important; }
            .content-wrapper { width: 100% !important; max-width: 100% !important; display: block !important; margin: 0 auto !important; }
            
            /* Remove grades e força blocos verticais um abaixo do outro */
            div[style*="display: flex"][style*="gap: 30px"], 
            div[style*="display: grid"] { 
                display: block !important; width: 100% !important; margin: 0 !important;
            }

            /* Estilização dos Cartões para o Papel A4 */
            ...
            /* Impede que os gráficos explodam e cortem no PDF */
            .print-chart { height: 280px !important; width: 100% !important; margin: 0 auto !important; page-break-inside: avoid !important; }
            .recharts-wrapper, .recharts-surface { width: 100% !important; height: 100% !important; overflow: visible !important; margin: 0 auto !important; }
            
            /* Ajuste de Legendas Especiais de Gráficos na aba Tributos */
            .chart-flex { display: flex !important; flex-direction: column !important; align-items: center !important; }
            .chart-left { width: 100% !important; height: 250px !important; margin-bottom: 20px !important; }
            .chart-right { width: 100% !important; display: block !important; overflow: visible !important; max-height: none !important; }
            
            /* Permite que as listas de CFOP e Produtos mostrem tudo sem barra de rolagem */
      ...
      {tipoAcesso === 'trial' && tempoRestante <= 0 && (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', backgroundColor: 'rgba(255,255,255,0.85)', backdropFilter: 'blur(10px)', zIndex: 9999, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '20px' }}>
          ...
          <button onClick={() => window.location.reload()} style={{ padding: '15px 30px', backgroundColor: '#004080', color: '#fff', border: 'none', borderRadius: '12px', fontSize: '18px', fontWeight: 'bold', cursor: 'pointer' }}>Sair do Sistema</button>
        </div>
      )}
      ...
      <div className="content-wrapper" style={{ width: '100%', maxWidth: '1600px', filter: tempoRestante <= 0 && tipoAcesso === 'trial' ? 'blur(5px)' : 'none', transition: 'filter 0.5s' }}>
        ...
        {faseAtual === 'dashboard' && (
          <div>
            ...
            {/* ========================================================================================= */}
            {/* ABA PRINCIPAL (HOME) - LAYOUT DE OURO RESTAURADO E GRÁFICOS MAIS GROSSOS                  */}
            {/* ========================================================================================= */}
            {abaAtiva === 'home' && (
              <div style={{ display: 'flex', gap: '30px', alignItems: 'flex-start' }}>
                ...
                <div className="print-dashboard-area" style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr 1.2fr', gap: '25px', alignItems: 'stretch', marginBottom: '25px' }}>
                    ...
                    <div className="print-card" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column' }}>
                      ...
                      <div className="print-chart" style={{ height: '300px', width: '100%', flexGrow: 1 }}>
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            {/* RAIO INTERNO DIMINUÍDO (60) PARA ENGROSSAR A ROSCA DE FORMA ELEGANTE */}
                            <Pie data={dadosGraficoOperacoes} cx="50%" cy="50%" innerRadius={60} outerRadius={100} paddingAngle={5} dataKey="value" animationDuration={1500}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                          ...
                          <div style={{ maxHeight: '280px', overflowY: 'auto', paddingRight: '5px' }}>
                            {listaCfops.entradas.length > 0 ? listaCfops.entradas.map((item, idx) => (
                              <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px', borderBottom: '1px solid #f0f4f8', fontSize: '14px' }}><span style={{ fontWeight: 'bold', color: '#555', whiteSpace: 'nowrap' }}>{item.cfop}</span><span style={{ color: '#10b981', fontWeight: '600', whiteSpace: 'nowrap' }}>{formatarMoeda(item.valor)}</span></div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', borderLeft: '1px solid #f0f4f8', paddingLeft: '20px' }}>
                          ...
                          <div style={{ maxHeight: '280px', overflowY: 'auto', paddingRight: '5px' }}>
                            {listaCfops.saidas.length > 0 ? listaCfops.saidas.map((item, idx) => (
                              <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', padding: '8px', borderBottom: '1px solid #f0f4f8', fontSize: '14px' }}><span style={{ fontWeight: 'bold', color: '#555', whiteSpace: 'nowrap' }}>{item.cfop}</span><span style={{ color: '#4f46e5', fontWeight: '600', whiteSpace: 'nowrap' }}>{formatarMoeda(item.valor)}</span></div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '25px', alignItems: 'stretch', marginTop: dadosVaf.vafTotal < 0 ? '40px' : '0', marginBottom: '25px' }}>
                    <div className="print-card" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column' }}>
                      ...
                      <div className="print-chart" style={{ height: '300px', width: '100%', flexGrow: 1 }}>
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            {/* RAIO INTERNO DIMINUÍDO (60) PARA ENGROSSAR A ROSCA DE FORMA ELEGANTE */}
                            <Pie data={dadosGraficoIcms} cx="50%" cy="50%" innerRadius={60} outerRadius={100} paddingAngle={5} dataKey="value" animationDuration={1500}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '25px' }}>
                      ...
                      <div className="print-card" style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', width: '100%', flexGrow: 1 }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '25px', alignItems: 'stretch' }}>
                    <div className="print-card" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column' }}>
            ...
            {abaAtiva === 'tributos' && (
              <div style={{ display: 'flex', gap: '30px', alignItems: 'flex-start' }}>
                ...
                <div className="print-dashboard-area" style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '25px' }}>
                  
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px' }}>
                    <div style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '20px', borderTop: '6px solid #004080', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                    ...
                    <div style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '20px', borderTop: '6px solid #f59e0b', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                    ...
                    <div style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '20px', borderTop: '6px solid #8b5cf6', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                    ...
                    <div style={{ backgroundColor: '#fff', padding: '25px', borderRadius: '20px', borderTop: '6px solid #ef4444', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', textAlign: 'center' }}>
                  ...
                  <div className="print-card" style={{ backgroundColor: '#fff', padding: '35px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                      ...
                      <div className="chart-flex" style={{ display: 'flex', alignItems: 'center', gap: '40px' }}>
                          <div className="chart-left" style={{ width: '45%', height: '350px' }}>
                              <ResponsiveContainer width="100%" height="100%">
                                  <PieChart>
                                      <Pie 
                                          data={dadosComparativoMensal} cx="50%" cy="50%" innerRadius={70} outerRadius={110} paddingAngle={6} cornerRadius={12} dataKey="value" animationDuration={1500}
                                          label={({ percent }) => `${(percent * 100).toFixed(1)}%`} labelLine={true} style={{ fontSize: '12px', fontWeight: 'bold' }}
                                      >
                          ...
                          <div className="chart-right" style={{ width: '55%', display: 'flex', flexDirection: 'column', gap: '15px' }}>
                              <h4 style={{ fontSize: '16px', color: '#666', borderBottom: '2px solid #f0f4f8', paddingBottom: '10px', margin: '0 0 5px 0' }}>Detalhamento Financeiro</h4>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '25px' }}>
                    <div className="print-card" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                      ...
                      <div className="chart-flex" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px' }}>
                        <div className="chart-left" style={{ width: '45%', height: '300px' }}>
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie data={dadosTributacaoSaida} cx="50%" cy="50%" innerRadius={60} outerRadius={95} paddingAngle={4} dataKey="value" animationDuration={1200}
                                label={({ percent }) => percent > 0.001 ? `${(percent * 100).toFixed(1)}%` : null} labelLine={true} style={{ fontSize: '11px', fontWeight: 'bold' }}
                              >
                        ...
                        <div className="chart-right" style={{ width: '55%', display: 'flex', flexDirection: 'column', gap: '10px', maxHeight: '300px', overflowY: 'auto', paddingRight: '5px' }}>
                    ...
                    <div className="print-card" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                      ...
                      <div className="chart-flex" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px' }}>
                        <div className="chart-left" style={{ width: '45%', height: '300px' }}>
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie data={dadosEstados} cx="50%" cy="50%" innerRadius={60} outerRadius={95} paddingAngle={4} dataKey="value" animationDuration={1200}
                                 label={({ percent }) => percent > 0.001 ? `${(percent * 100).toFixed(1)}%` : null} labelLine={true} style={{ fontSize: '11px', fontWeight: 'bold' }}
                              >
                  ...
                  <div className="print-card" style={{ backgroundColor: '#fff', padding: '30px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                      ...
                      <div className="chart-flex" style={{ display: 'flex', alignItems: 'center', gap: '40px' }}>
                          <div className="chart-left" style={{ width: '40%', height: '350px' }}>
                              <ResponsiveContainer width="100%" height="100%">
                                  <PieChart>
                                      <Pie data={dadosRoscaEntradas} cx="50%" cy="50%" innerRadius={65} outerRadius={105} paddingAngle={4} dataKey="value" animationDuration={1200}
                                          label={({ percent }) => percent > 0.001 ? `${(percent * 100).toFixed(1)}%` : null} labelLine={true} style={{ fontSize: '11px', fontWeight: 'bold' }}
                                      >
                          ...
                          <div className="chart-right" style={{ width: '60%', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', maxHeight: '350px', overflowY: 'auto', paddingRight: '10px' }}>
                ...
                <div className="no-print" style={{ width: '320px', flexShrink: 0, backgroundColor: '#fff', borderRadius: '20px', padding: '30px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', position: 'sticky', top: '30px' }}>
                  ...
                  <div style={{ backgroundColor: '#f8fafc', padding: '15px', borderRadius: '12px', borderLeft: '4px solid #10b981', marginBottom: '15px' }}>
                    <span style={{ display: 'block', fontSize: '13px', color: '#666', fontWeight: '600' }}>Totalizadores Corrigidos</span>
                    <strong style={{ fontSize: '22px', color: '#10b981' }}>{relatorioCorrecoes.blocosRecalculados}</strong>
                    <span style={{ display: 'block', fontSize: '11px', color: '#999', marginTop: '4px' }}>C990, 9990, 9999</span>
                  </div>
            ...
            {/* ABA AUDITORIA (LOG) */}
            {abaAtiva === 'auditoria' && (
              <div className="print-card" style={{ backgroundColor: '#fff', padding: '40px', borderRadius: '20px', boxShadow: '0 10px 30px rgba(0,0,0,0.05)', width: '100%' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '3px solid #f0f4f8', paddingBottom: '20px', marginBottom: '30px' }}>
                   ...
                   <button className="no-print" onClick={() => window.print()} style={{ padding: '10px 20px', backgroundColor: '#10b981', color: '#fff', border: 'none', borderRadius: '10px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}><Printer size={18}/> Salvar PDF</button>
                </div>
