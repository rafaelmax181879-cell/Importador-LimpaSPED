...
export default function ImportadorSped() {
  ...
  return (
    <div className="main-container">
      <style>
        {`
          /* CSS OTIMIZADO PARA GARANTIR LARGURA TOTAL E PREVENIR CORTES */
          ...
          /* Layout Lateral Fixo e Responsivo */
          ...
          /* Componentes Visuais Comprimidos */
          ...
          .leg-val { font-size: 14px; color: #004080; margin-left: 10px; font-weight: bold; }
          ...
          /* MODO DE IMPRESSÃO PREMIUM PDF BLINDADO */
          @media print {
            ...
            /* Remove cortes de listas e graficos */
                    ...
                    <div className="card-dash">
                      ...
                      <div className="print-chart" style={{ height: '300px', width: '100%' }}>
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie data={dadosGraficoOperacoes} cx="50%" cy="50%" innerRadius={65} outerRadius={110} paddingAngle={5} dataKey="value">
                  ...
                  <div className="grid-2" style={{ marginTop: dadosVaf.vafTotal < 0 ? '40px' : '0' }}>
                    <div className="card-dash">
                      ...
                      <div className="print-chart" style={{ height: '280px', width: '100%' }}>
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie data={dadosGraficoIcms} cx="50%" cy="50%" innerRadius={65} outerRadius={110} paddingAngle={5} dataKey="value">
                ...
                <div className="dash-main">
                  ...
                  <div className="card-dash">
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '30px', alignItems: 'center' }}>
                      <div className="print-chart" style={{ flex: '1 1 300px', height: '350px' }}>
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart><Pie data={dadosComparativoMensal} cx="50%" cy="50%" innerRadius={70} outerRadius={110} paddingAngle={6} dataKey="value" label={({percent})=>percent>0?`${(percent*100).toFixed(1)}%`:null}>{dadosComparativoMensal.map((e, i) => <Cell key={i} fill={e.fill} />)}</Pie><Tooltip formatter={(v)=>formatarMoeda(v)} /></PieChart>
                        </ResponsiveContainer>
                      </div>
                  ...
                  <div className="grid-2">
                    <div className="card-dash">
                      ...
                      <div className="print-chart" style={{ height: '300px' }}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={dadosTributacaoSaida} cx="50%" cy="50%" innerRadius={60} outerRadius={95} paddingAngle={4} dataKey="value" label={({percent})=>percent>0?`${(percent*100).toFixed(1)}%`:null}>{dadosTributacaoSaida.map((e, i)=><Cell key={i} fill={CORES_TRIBUTACAO[i%CORES_TRIBUTACAO.length]} />)}</Pie><Tooltip formatter={(v)=>formatarMoeda(v)}/></PieChart></ResponsiveContainer></div>
                    ...
                    <div className="card-dash">
                      ...
                      <div className="print-chart" style={{ height: '300px' }}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={dadosEstados} cx="50%" cy="50%" innerRadius={60} outerRadius={95} paddingAngle={4} dataKey="value" label={({percent})=>percent>0?`${(percent*100).toFixed(1)}%`:null}>{dadosEstados.map((e, i)=><Cell key={i} fill={CORES_MAPA[i%CORES_MAPA.length]} />)}</Pie><Tooltip formatter={(v)=>formatarMoeda(v)}/></PieChart></ResponsiveContainer></div>
                  ...
                  <div className="card-dash">
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '30px', alignItems: 'center' }}>
                      <div className="print-chart" style={{ flex: '1 1 300px', height: '350px' }}>
                        <ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={dadosRoscaEntradas} cx="50%" cy="50%" innerRadius={65} outerRadius={110} paddingAngle={4} dataKey="value" label={({percent})=>percent>0?`${(percent*100).toFixed(1)}%`:null}>{dadosRoscaEntradas.map((e, i)=><Cell key={i} fill={CORES_ENTRADAS[i%CORES_ENTRADAS.length]} />)}</Pie><Tooltip formatter={(v)=>formatarMoeda(v)}/></PieChart></ResponsiveContainer>
                      </div>
